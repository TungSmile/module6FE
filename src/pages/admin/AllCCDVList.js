    ...
    return (
        <>
            ...
            <div className="main_content_iner overly_inner ">
                                    ...
                                    <div className="QA_section">
                                        ...
                                        <div className="QA_table mb_30">
                                            <table className="table lms_table_active ">
                                                <thead>
                                                <tr>
                                                    <th scope="col" style={{fontSize: '14px', fontWeight: 'bold'}}>id
                                                    </th>
                                                    <th scope="col" style={{fontSize: '14px', fontWeight: 'bold'}}>Biệt
                                                        danh
                                                    </th>
                                                    <th scope="col" style={{fontSize: '14px', fontWeight: 'bold'}}>Tên
                                                        tài khoản
                                                    </th>
                                                    <th scope="col"
                                                        style={{fontSize: '14px', fontWeight: 'bold'}}>Email
                                                    </th>
                                                    <th scope="col" style={{fontSize: '14px', fontWeight: 'bold'}}>Vai
                                                        trò
                                                    </th>
                                                    <th scope="col" style={{fontSize: '14px', fontWeight: 'bold'}}>Trạng
                                                        thái
                                                    </th>
                                                    <th scope="col" style={{fontSize: '14px', fontWeight: 'bold'}}>Hoạt
                                                        động
                                                    </th>
                                                </tr>
                                                </thead>
                                                ...
                                                {currenAllUser.length > 0 && currenAllUser.map((item) => (
                                                    <tr>
                                                        ...
                                                        <td onClick={() => {
                                                            addUserChat(item.account.username)
                                                        }} style={{cursor: "pointer"}}>{item.account.nickname}</td>
                                                        ...
                                                        <td>
                                                            {item.account.status.nameStatus === "block" &&
                                                                <a href="#" className="status_btn"
                                                                   style={{backgroundColor: 'red', width: '127px'}}>
                                                                    Tài khoản bị khóa
                                                                </a>
                                                            }
                                                            {item.account.status.nameStatus === "active" &&
                                                                <a href="#" className="status_btn"
                                                                   style={{backgroundColor: '#05d34e', width: '127px'}}>
                                                                    Đã khích hoạt
                                                                </a>
                                                            }
                                                            {item.account.status.nameStatus === "register" &&
                                                                <a href="#" className="status_btn"
                                                                   style={{backgroundColor: 'orange', width: '127px'}}>
                                                                    Chờ xác nhận
                                                                </a>
                                                            }
                                                        </td>
                ...
                {showDetail && detailCCDV.account.id !== undefined && detailCCDV.userProfile.id !== undefined &&
                    <DetailCCDV data={detailCCDV}/>}
            </div>
